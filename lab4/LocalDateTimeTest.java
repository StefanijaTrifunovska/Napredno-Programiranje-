...
public class LocalDateTimeTest {
    ...
    static LocalDateTime localDateTimeOf() {
         ...
         */
        LocalDateTime ldt = LocalDateTime.of(2015, 06, 20, 23, 07, 30);
        return ldt;
    }
    ...
    static LocalDateTime localDateTimeParse() {
         ...
         */
        //LocalDateTime ldt = LocalDateTime.parse("2015-06-20 23:07:30");
        LocalDateTime ldt = LocalDateTime.of(2015, 06, 20, 23, 07, 30);
        ldt = LocalDateTime.parse("2015-06-20T23:07:30");
    ...
    static LocalDateTime localTimeWith() {
         ...
         */
        ldt = ldt.with(TemporalAdjusters.firstDayOfNextMonth());
    ...
    static LocalDateTime localDatePlusMinus() {
         ...
         */
       ldt =  ldt.plusMonths(10);
       
       ldt =  ldt.minusHours(5);
        //System.out.print("Sto se deshava tuka");
        return ldt;
