...
public class LocalTimeTest {
    ...
    static LocalTime localTimeOfHourToMinute() {
         ...
         */
        LocalTime time = LocalTime.of(23, 07);
    ...
    static LocalTime localTimeOfHourToNanoSec() {
         ...
         */
        LocalTime time = LocalTime.of(23, 07, 03, 100000000);
        return time;
    }
    ...
    static LocalTime localTimeParse() {
         ...
         */
        LocalTime time = LocalTime.parse("23:07:03.1");
        return time;
    }
    ...
    static LocalTime localTimeMinusDuration() {
         ...
         */
        lt = lt.minusHours(3);
        lt = lt.minusMinutes(30);
        lt = lt.minusSeconds(20);
        lt = lt.minusNanos(200000000);
        return lt;
    }
